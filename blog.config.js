...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AlanGu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'An ordinary worker!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.alangyc.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || "AlanGu, Bolg", // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'alangyc@yeah.net', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://www.alangyc.top/Wechat_Links', // 你的twitter个人主页
  ...
  WIDGET_PET_LINK:
    ...
    'https://imuncle.github.io/live2d/model/bronya_1/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'AlanGu Bolg', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'This site is shared by AlanGu', // 站点描述，被notion中的页面描述覆盖
